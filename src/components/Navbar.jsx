...
const Navbar = () => {
  ...
  const handleLogOut = async() =>{
    ...
    return (
        ...
        <div className="flex-1">
          <a className="btn btn-ghost text-xl">BD Bazar</a>
        </div>
       <div className=''>
       <input type="text" placeholder="Type here" className="input rounded-none input-sm w-96" />
        <button className="btn btn-ghost btn-sm rounded-none bg-orange-500">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
    </button>
       </div>
  ...
  <input onChange={toggleTheme} type="checkbox" checked={theme ==="dark"} className="theme-controller" value="synthwave" />
